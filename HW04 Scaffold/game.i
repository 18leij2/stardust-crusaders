...
enum {BLACKID=(256-10), WHITEID, GRAYID, REDID, GREENID, BLUEID, CYANID, MAGENTAID, YELLOWID, BROWNID};
...
# 1 "dodge.h" 1
# 21 "dodge.h"
extern const unsigned short dodgeBitmap[648];
...
# 1 "shipProto.h" 1
# 21 "shipProto.h"
extern const unsigned short shipProtoBitmap[648];


extern const unsigned short shipProtoPal[256];
# 7 "game.c" 2
# 1 "sound.h" 1
# 74 "sound.h"
enum {
...
int lives;
int highscore;
unsigned short colors[10] = {(((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10), (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10), (((15) & 31) | ((15) & 31) << 5 | ((15) & 31) << 10), (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10), (((0) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10), (((0) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10), (((0) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10), (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10), (((31) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10), (((18) & 31) | ((8) & 31) << 5 | ((2) & 31) << 10)};
...
void initGame() {
    ...
    DMANow(3, shipProtoPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, dodgePal, ((unsigned short *)0x5000000), 16);
...
void updatePlayer() {
    ...
    if (((!(~(oldButtons) & ((1<<9))) && (~(buttons) & ((1<<9)))) || (!(~(oldButtons) & ((1<<8))) && (~(buttons) & ((1<<8))))) && !player.dodge) {
        player.dodge = 1;
        player.iframes = 1;
        player.speed = 4;
